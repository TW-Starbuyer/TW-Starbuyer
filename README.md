...
<p align="left">I have interdisciplinary interests in computer graphics (raytracing, high-performance graphics), computational mathematics (computational geometry/topology), and AI/ML (LLMs/SLMs, neural networks). As a research assistant I've contributed to many projects at the college. I was a Summer Undergraduate Research Fellow at the college last summer (2024), leading the research and development of the EDUHints small language model hint generation system. For this work I won the first place prize at CCSCNW's 2024 student research poster competition, and recently authored my first conference paper (accepted).</p>
